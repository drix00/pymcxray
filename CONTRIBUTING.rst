...
pymcxray could always use more documentation, whether as part of the
official pymcxray docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4 and 3.5, and for PyPy. Check
   https://travis-ci.org/drix00/pymcxray/pull_requests
