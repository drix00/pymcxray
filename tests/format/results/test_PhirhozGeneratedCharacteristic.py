#!/usr/bin/env python
"""
.. py:currentmodule:: format.results.test_PhirhozGeneratedCharacteristic
...
# Project modules
import mcxray.format.results.PhirhozGeneratedCharacteristic as PhirhozGeneratedCharacteristic
