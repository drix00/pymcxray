#!/usr/bin/env python
"""
.. py:currentmodule:: format.results.test_XraySimulatedSpectraSpecimen
...
# Project modules
import mcxray.format.results.XraySimulatedSpectraSpecimen as XraySimulatedSpectraSpecimen
...
class TestXraySimulatedSpectraSpecimen(unittest.TestCase):
    ...
    def test_read(self):
        ...
        self.assertEqual(1024, len(spectrumFile.totals))
