#!/usr/bin/env python
"""
.. py:currentmodule:: format.results.test_XraySpectraAtomEmittedDetectedLines
...
# Project modules
import mcxray.format.results.XraySpectraAtomEmittedDetectedLines as XraySpectraAtomEmittedDetectedLines
...
class TestXraySpectraAtomEmittedDetectedLines(unittest.TestCase):
    ...
    def test_read(self):
        ...
        self.assertEqual(0.0025, spectrumFile.energies_keV[0])
        self.assertEqual(4.9975, spectrumFile.energies_keV[-1])
        self.assertEqual(1000, len(spectrumFile.energies_keV))
        self.assertEqual(1, len(spectrumFile.characteristics))
        self.assertEqual(1000, len(spectrumFile.characteristics['Au']))
