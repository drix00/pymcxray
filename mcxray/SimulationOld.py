...
# Local modules.
from mcxray.ElementProperties import getAtomicMass_g_mol
...
from mcxray.SimulationsParameters import PARAMETER_INCIDENT_ENERGY_keV, PARAMETER_NUMBER_ELECTRONS, \
